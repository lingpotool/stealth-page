...
export const Keys = {
  // 组合键
  CTRL_A: ["Control", "a"] as const,
  CTRL_C: ["Control", "c"] as const,
  CTRL_X: ["Control", "x"] as const,
  CTRL_V: ["Control", "v"] as const,
  CTRL_Z: ["Control", "z"] as const,
  CTRL_Y: ["Control", "y"] as const,
 ...
 */
export const keyDefinitions: Record<string, {
  key: string;
  keyCode: number;
  code: string;
  text?: string;
